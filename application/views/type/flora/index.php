    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Flora Type</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Flora Type Data</h3>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped display table-flora-type" style="width: 100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>UUID</th>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title">Form Add Flora Type</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= base_url('Type/createFloraType') ?>" method="post" class="formCreate">
        ...
        <div class="modal fade modal-update">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title">Form Update Flora Type</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= base_url('Type/updateFloraType') ?>" method="post" class="formUpdate">
                        <div class="modal-body">
...
<script>
    $(document).ready(function() {
        var table = $('.table-flora-type').DataTable({
            processing      : true,
            serverSide      : true,
            scrollX         : true,
            scrollCollapse  : true,
            ...
            "ordering"      : false,
            "ajax"          : {
                "url": "<?= base_url('Type/readFloraType'); ?>",
                "type": "POST"
            },
            "columns": [
        ...
        table.on('click', '.btn-delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?= base_url('Type/deleteFloraType'); ?>",
                        type: 'POST',
                        dataType: 'JSON',
                        data : {'uuid' : uuid },
                        success : function(response) {
