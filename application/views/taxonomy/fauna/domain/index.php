    ...
    <div class="content-wrapper">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title">Form Add Fauna Domain</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= base_url('Taxonomy/createFaunaDomain') ?>" method="post" class="formCreateDomain">
        ...
        <div class="modal fade modal-update-domain">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title">Form Update Fauna Domain</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= base_url('Taxonomy/updateFaunaDomain') ?>" method="post" class="formUpdateDomain">
                        <div class="modal-body">
...
<script>
    $(document).ready(function() {
        var table = $('.table-domain').DataTable({
            ...
            "ordering"      : false,
            "ajax"          : {
                "url": "<?= base_url('Taxonomy/readFaunaDomain'); ?>",
                "type": "POST"
            },
            "columns": [
        ...
        table.on('click', '.btn-delete-domain', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?= base_url('Taxonomy/deleteFaunaDomain'); ?>",
                        type: 'POST',
                        dataType: 'JSON',
                        data : {'uuid' : uuid },
                        success : function(response) {
