    ...
    <div class="content-wrapper">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title">Form Add Fauna Class</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= base_url('Taxonomy/createFaunaClass') ?>" method="post" class="formCreateClass">
        ...
        <div class="modal fade modal-update-class">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title">Form Update Fauna Class</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= base_url('Taxonomy/updateFaunaClass') ?>" method="post" class="formUpdateClass">
                        <div class="modal-body">
...
<script>
    $(document).ready(function() {
        var table = $('.table-class').DataTable({
            ...
            "ordering"      : false,
            "ajax"          : {
                "url": "<?= base_url('Taxonomy/readFaunaClass'); ?>",
                "type": "POST"
            },
            "columns": [
        ...
        table.on('click', '.btn-delete-class', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?= base_url('Taxonomy/deleteFaunaClass'); ?>",
                        type: 'POST',
                        dataType: 'JSON',
                        data : {'uuid' : uuid },
                        success : function(response) {
