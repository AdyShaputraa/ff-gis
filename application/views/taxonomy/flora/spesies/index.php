    ...
    <div class="content-wrapper">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title">Form Add Flora Spesies</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= base_url('Taxonomy/createFloraSpesies') ?>" method="post" class="formCreateSpesies">
        ...
        <div class="modal fade modal-update-spesies">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title">Form Update Flora Spesies</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?= base_url('Taxonomy/updateFloraSpesies') ?>" method="post" class="formUpdateSpesies">
                        <div class="modal-body">
...
<script>
    $(document).ready(function() {
        var table = $('.table-spesies').DataTable({
            ...
            "ordering"      : false,
            "ajax"          : {
                "url": "<?= base_url('Taxonomy/readFloraSpesies'); ?>",
                "type": "POST"
            },
            "columns": [
        ...
        table.on('click', '.btn-delete-spesies', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?= base_url('Taxonomy/deleteFloraSpesies'); ?>",
                        type: 'POST',
                        dataType: 'JSON',
                        data : {'uuid' : uuid },
                        success : function(response) {
